...
import ovh.herisson.tonitch.block.Containers.Screens.ScreenATM;
import ovh.herisson.tonitch.block.Containers.ModContainers;
...
public class HBM {
    ...
    private void setup(final FMLCommonSetupEvent event) {
        ...
        ScreenManager.registerFactory(ModContainers.atm, ScreenATM::new);
    }
}
